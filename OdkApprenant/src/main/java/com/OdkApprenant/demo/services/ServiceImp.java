...
public class  ServiceImp implements ApprenantService,  FormateurService, PresenceService{
    ...
    public List<Presence> getPresenceList(int year, int month) {
        ...
        return this.presenceRepository.getPresenceByDateGreaterThanEqualAndDateLessThanEqual(start, end);
    }

    @Override
    public List<Presence> getPresenceList(LocalDate min, LocalDate max) {
        return this.presenceRepository.getPresenceByDateGreaterThanEqualAndDateLessThanEqual(min, max);
    }
